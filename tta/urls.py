...
urlpatterns = patterns('',
    ...
    (r'^(\w+)/(\w+)/notify/$', 'tta.game.views.notify'),
    (r'^(\w+)/(\w+)/play/(\d+)/$', 'tta.game.views.play'),
    (r'^(\w+)/(\w+)/discard/(\d+)/$', 'tta.game.views.discard'),
    (r'^(\w+)/(\w+)/discard_leader/$', 'tta.game.views.discard_leader'),
    (r'^(\w+)/(\w+)/play_event/(\d+)/$', 'tta.game.views.play_event'),
    (r'^(\w+)/(\w+)/play_aggression/(\d+)/$', 'tta.game.views.play_aggression'),
    (r'^(\w+)/(\w+)/play_pact/(\d+)/$', 'tta.game.views.play_pact'),
    (r'^(\w+)/(\w+)/remove_aggression/(\d+)/$', 'tta.game.views.remove_aggression'),
    (r'^(\w+)/(\w+)/remove_pact/(\d+)/$', 'tta.game.views.remove_pact'),
